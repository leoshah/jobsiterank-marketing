...
export const CASE_STUDIES: CaseStudy[] = [
  // ───────── Text-back (3) ─────────
  {
    slug: "crown-city-plumbing-pasadena",
    category: "text-back",
    fileNum: "002",
    business: "Crown City Plumbing",
    trade: "Plumbing · res & emergency",
    city: "Pasadena",
    state: "CA",
    engagement: "Never Miss a Lead · 4 months",
    cardHook: "Caught 38% of after-hours emergency calls — water heaters, drain backups, slab leaks.",
    cardMetricValue: "+27",
    cardMetricLabel: "Booked jobs / mo from text-back",
    titleStart: "Crown City Plumbing",
    titleAccent: "stops bleeding leads to voicemail.",
    intro: "Family-owned Pasadena plumbing shop watching after-hours calls vanish into voicemail night after night — water heater leaks, drain backups, the usual emergency mix in older SGV homes. They'd tried an answering service the year before — accuracy was bad enough they cancelled it. We wired text-back to their main 818 line on day one. By the end of week two, 38% of after-hours callers were booking via SMS instead of dialing the next plumber.",
    intakeFacts: [
      { label: "Trade", value: "Plumbing · residential + emergency" },
      { label: "Service area", value: "Pasadena + San Gabriel Valley" },
    ...
    timeline: [
      ...
      { week: "Week 1", label: "Twilio wiring", detail: "Connected three 818 lines through the JobsiteRank inbox. Tested with internal numbers for two days before going live — caught a routing bug on the way." },
    ...
    quoteAuthor: "Karen M.",
    quoteAttribution: "Co-owner · Crown City Plumbing · Pasadena",
    quoteInitials: "KM",
    representative: true,
  },
  {
