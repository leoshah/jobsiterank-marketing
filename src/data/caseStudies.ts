...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  // ───────── Reviews & replies (2) ─────────
  {
    ...
    beforeAfter: [
      ...
      { label: "Avg star rating", delta: "4.5 → 4.8", detail: "More reviews + faster issue resolution on negatives" },
    ...
    timeline: [
      ...
      { week: "Month 2", label: "Replies on", detail: "Our team began replying to every review within 48 hours. Negative reviews escalated to owner with a draft response. Caught two angry customers we resolved off-platform." },
  ...
  },
  {
    ...
    state: "NY",
    engagement: "Local Authority · 7 months",
    cardHook: "Triaged 14 unresolved 1-star reviews. Got 8 updated to 5 stars after follow-up.",
    cardMetricValue: "8 of 14",
    cardMetricLabel: "Negative reviews resolved & updated",
    titleStart: "Tideway Plumbing",
    titleAccent: "turns angry customers into 5-star repairs.",
    intro: "Long Island plumber with a 4.1 star rating dragged down by a handful of unresolved 1- and 2-star reviews. Our team triaged each one within 24 hours, the owner personally followed up to fix the underlying issue, and 8 of 14 customers updated their reviews to 5 stars. Three more deleted their reviews. Three didn't respond.",
    intakeFacts: [
      { label: "Trade", value: "Plumbing · residential" },
    ...
    beforeAfter: [
      { label: "Star rating", delta: "4.1 → 4.7", detail: "After resolving 8 of 14 legacy 1-star reviews and stacking new 5-stars on top" },
      { label: "Negative review response time", delta: "−92%", detail: "5+ days avg → ~6 hours avg" },
      { label: "Inbound conversion rate", delta: "+18%", detail: "Higher star rating = more clicks-to-call from map pack" },
    ],
    metrics: [
      { value: "4.7★", label: "Current rating (was 4.1)" },
      { value: "14", label: "Negative reviews triaged" },
      { value: "8", label: "Updated to 5 stars after resolution" },
      { value: "~6 hr", label: "Avg negative-review response time" },
      { value: "100%", label: "Reviews replied to within 24h" },
      { value: "+18%", label: "Click-to-call lift on map pack" },
    ],
    timeline: [
      { week: "Week 0", label: "Reputation audit", detail: "Pulled 18 months of reviews. Identified 14 unresolved 1- and 2-star complaints, mostly about scheduling miscommunications and one billing dispute." },
      { week: "Week 1", label: "Triage protocol", detail: "Our team started responding to every review within 6 hours. Owner approved each negative response before it went live." },
      { week: "Month 2", label: "Outreach to 1-star customers", detail: "Personally followed up with each 1-star reviewer. Offered free service call to re-do or refund. 4 said no, 10 accepted." },
      { week: "Month 4", label: "Updates rolling in", detail: "8 of the 10 who accepted updated their reviews to 5 stars after resolution. 3 deleted their reviews. 3 never responded." },
      { week: "Month 7", label: "Sustained", detail: "Star rating now 4.7 — not 5.0, won't be, that's fine. Inbound clicks from map pack up 18% YoY." },
    ],
    quote: "Those old 1-stars were a tax on every new customer. Most of them turned out to be scheduling stuff we could just fix. Don't know why I waited so long to call them back.",
    quoteAuthor: "Vinny C.",
